...
export const Message = {
  ...
  fromJSON(object: any): Message {
    return {
      ...
      hash: isSet(object.hash)
        ...
        : new Uint8Array(),
      hashScheme: isSet(object.hashScheme)
        ? hashSchemeFromJSON(object.hashScheme)
        : 0,
      signature: isSet(object.signature)
        ? bytesFromBase64(object.signature)
        : new Uint8Array(),
      signatureScheme: isSet(object.signatureScheme)
        ? signatureSchemeFromJSON(object.signatureScheme)
        : 0,
  ...
  toJSON(message: Message): unknown {
    ...
    message.data !== undefined &&
      (obj.data = message.data ? MessageData.toJSON(message.data) : undefined);
    message.hash !== undefined &&
      (obj.hash = base64FromBytes(
        message.hash !== undefined ? message.hash : new Uint8Array()
      ));
    message.hashScheme !== undefined &&
      (obj.hashScheme = hashSchemeToJSON(message.hashScheme));
    message.signature !== undefined &&
      (obj.signature = base64FromBytes(
        message.signature !== undefined ? message.signature : new Uint8Array()
      ));
    message.signatureScheme !== undefined &&
    ...
    message.dataBytes !== undefined &&
      (obj.dataBytes =
        message.dataBytes !== undefined
          ? base64FromBytes(message.dataBytes)
          : undefined);
    return obj;
  },
...
export const MessageData = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9:
          ...
          message.verificationAddAddressBody =
            VerificationAddAddressBody.decode(reader, reader.uint32());
          continue;
        case 10:
          if (tag != 82) {
            break;
        ...
        case 15:
          ...
          message.usernameProofBody = UserNameProof.decode(
            reader,
            reader.uint32()
          );
          continue;
  ...
  fromJSON(object: any): MessageData {
    return {
      ...
      network: isSet(object.network)
        ? farcasterNetworkFromJSON(object.network)
        : 0,
      castAddBody: isSet(object.castAddBody)
        ? CastAddBody.fromJSON(object.castAddBody)
        : undefined,
      castRemoveBody: isSet(object.castRemoveBody)
        ? CastRemoveBody.fromJSON(object.castRemoveBody)
        : undefined,
      ...
      verificationRemoveBody: isSet(object.verificationRemoveBody)
        ...
        : undefined,
      userDataBody: isSet(object.userDataBody)
        ? UserDataBody.fromJSON(object.userDataBody)
        : undefined,
      linkBody: isSet(object.linkBody)
        ? LinkBody.fromJSON(object.linkBody)
        : undefined,
  ...
  toJSON(message: MessageData): unknown {
    ...
    message.castAddBody !== undefined &&
      (obj.castAddBody = message.castAddBody
        ? CastAddBody.toJSON(message.castAddBody)
        : undefined);
    message.castRemoveBody !== undefined &&
      (obj.castRemoveBody = message.castRemoveBody
        ? CastRemoveBody.toJSON(message.castRemoveBody)
        : undefined);
    message.reactionBody !== undefined &&
      (obj.reactionBody = message.reactionBody
    ...
    message.userDataBody !== undefined &&
      (obj.userDataBody = message.userDataBody
        ? UserDataBody.toJSON(message.userDataBody)
        : undefined);
    message.linkBody !== undefined &&
      (obj.linkBody = message.linkBody
        ? LinkBody.toJSON(message.linkBody)
        : undefined);
    message.usernameProofBody !== undefined &&
      (obj.usernameProofBody = message.usernameProofBody
        ? UserNameProof.toJSON(message.usernameProofBody)
        : undefined);
  ...
  fromPartial<I extends Exact<DeepPartial<MessageData>, I>>(
    ...
    message.reactionBody =
      object.reactionBody !== undefined && object.reactionBody !== null
        ...
        : undefined;
    message.verificationAddAddressBody =
      object.verificationAddAddressBody !== undefined &&
      object.verificationAddAddressBody !== null
        ? VerificationAddAddressBody.fromPartial(
            object.verificationAddAddressBody
          )
        : undefined;
    message.verificationRemoveBody =
      object.verificationRemoveBody !== undefined &&
      object.verificationRemoveBody !== null
    ...
    message.linkBody =
      object.linkBody !== undefined && object.linkBody !== null
        ...
        : undefined;
    message.usernameProofBody =
      object.usernameProofBody !== undefined &&
      object.usernameProofBody !== null
...
export const UserDataBody = {
  ...
  create<I extends Exact<DeepPartial<UserDataBody>, I>>(
    base?: I
  ): UserDataBody {
    return UserDataBody.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<UserDataBody>, I>>(
    object: I
  ): UserDataBody {
    const message = createBaseUserDataBody();
    message.type = object.type ?? 0;
...
export const Embed = {
  ...
  toJSON(message: Embed): unknown {
    ...
    message.castId !== undefined &&
      (obj.castId = message.castId ? CastId.toJSON(message.castId) : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Embed>, I>>(object: I): Embed {
    ...
    message.castId =
      object.castId !== undefined && object.castId !== null
...
export const CastAddBody = {
  ...
  fromJSON(object: any): CastAddBody {
    return {
      ...
      mentions: Array.isArray(object?.mentions)
        ? object.mentions.map((e: any) => Number(e))
        : [],
      parentCastId: isSet(object.parentCastId)
        ? CastId.fromJSON(object.parentCastId)
        : undefined,
  ...
  toJSON(message: CastAddBody): unknown {
    ...
    message.parentCastId !== undefined &&
      (obj.parentCastId = message.parentCastId
        ? CastId.toJSON(message.parentCastId)
        : undefined);
    message.parentUrl !== undefined && (obj.parentUrl = message.parentUrl);
    message.text !== undefined && (obj.text = message.text);
    if (message.mentionsPositions) {
      obj.mentionsPositions = message.mentionsPositions.map((e) =>
        Math.round(e)
      );
    } else {
  ...
  fromPartial<I extends Exact<DeepPartial<CastAddBody>, I>>(
    object: I
  ): CastAddBody {
    const message = createBaseCastAddBody();
...
export const CastRemoveBody = {
  ...
  fromJSON(object: any): CastRemoveBody {
    return {
      targetHash: isSet(object.targetHash)
        ? bytesFromBase64(object.targetHash)
        : new Uint8Array(),
    };
  },
  ...
  toJSON(message: CastRemoveBody): unknown {
    ...
    message.targetHash !== undefined &&
      (obj.targetHash = base64FromBytes(
        message.targetHash !== undefined ? message.targetHash : new Uint8Array()
      ));
    return obj;
  },

  create<I extends Exact<DeepPartial<CastRemoveBody>, I>>(
    base?: I
  ): CastRemoveBody {
    return CastRemoveBody.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<CastRemoveBody>, I>>(
    object: I
  ): CastRemoveBody {
    const message = createBaseCastRemoveBody();
...
export const ReactionBody = {
  ...
  fromJSON(object: any): ReactionBody {
    return {
      ...
      targetCastId: isSet(object.targetCastId)
        ? CastId.fromJSON(object.targetCastId)
        : undefined,
  ...
  toJSON(message: ReactionBody): unknown {
    ...
    message.targetCastId !== undefined &&
      (obj.targetCastId = message.targetCastId
        ? CastId.toJSON(message.targetCastId)
        : undefined);
    message.targetUrl !== undefined && (obj.targetUrl = message.targetUrl);
    return obj;
  },

  create<I extends Exact<DeepPartial<ReactionBody>, I>>(
    base?: I
  ): ReactionBody {
    return ReactionBody.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<ReactionBody>, I>>(
    object: I
  ): ReactionBody {
    const message = createBaseReactionBody();
    message.type = object.type ?? 0;
...
export const VerificationAddAddressBody = {
  ...
  toJSON(message: VerificationAddAddressBody): unknown {
    ...
    message.verificationType !== undefined &&
  ...
  create<I extends Exact<DeepPartial<VerificationAddAddressBody>, I>>(
    base?: I
  ): VerificationAddAddressBody {
    return VerificationAddAddressBody.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<VerificationAddAddressBody>, I>>(
    object: I
  ): VerificationAddAddressBody {
    const message = createBaseVerificationAddAddressBody();
...
export const VerificationRemoveBody = {
  ...
  create<I extends Exact<DeepPartial<VerificationRemoveBody>, I>>(
    base?: I
  ): VerificationRemoveBody {
    return VerificationRemoveBody.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<VerificationRemoveBody>, I>>(
    object: I
  ): VerificationRemoveBody {
    const message = createBaseVerificationRemoveBody();
    message.address = object.address ?? new Uint8Array();
...
export const LinkBody = {
  ...
  fromJSON(object: any): LinkBody {
    return {
      ...
      displayTimestamp: isSet(object.displayTimestamp)
        ? Number(object.displayTimestamp)
        : undefined,
  ...
  toJSON(message: LinkBody): unknown {
    ...
    message.displayTimestamp !== undefined &&
      (obj.displayTimestamp = Math.round(message.displayTimestamp));
    message.targetFid !== undefined &&
...
export const FrameActionBody = {
  ...
  fromJSON(object: any): FrameActionBody {
    return {
      ...
      inputText: isSet(object.inputText)
        ? bytesFromBase64(object.inputText)
        : new Uint8Array(),
  ...
  toJSON(message: FrameActionBody): unknown {
    ...
    message.inputText !== undefined &&
      (obj.inputText = base64FromBytes(
        message.inputText !== undefined ? message.inputText : new Uint8Array()
      ));
  ...
  create<I extends Exact<DeepPartial<FrameActionBody>, I>>(
    base?: I
  ): FrameActionBody {
    return FrameActionBody.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<FrameActionBody>, I>>(
    object: I
  ): FrameActionBody {
    const message = createBaseFrameActionBody();
