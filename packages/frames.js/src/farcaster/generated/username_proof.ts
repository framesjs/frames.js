...
export const UserNameProof = {
  ...
  toJSON(message: UserNameProof): unknown {
    ...
    message.name !== undefined &&
      (obj.name = base64FromBytes(
        message.name !== undefined ? message.name : new Uint8Array()
      ));
  ...
  create<I extends Exact<DeepPartial<UserNameProof>, I>>(
    base?: I
  ): UserNameProof {
    return UserNameProof.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<UserNameProof>, I>>(
    object: I
  ): UserNameProof {
    const message = createBaseUserNameProof();
