    ...
    const frameState = useFrame({
      ...
      onLaunchFrameButtonPressed(event) {
        if (event.status === "partial") {
          ...
          setLaunchedFrame(event);
        }
      },
      onLaunchedFrameClosed() {
        setLaunchedFrame(null);
      },
    });
      ...
      <>
                  ...
                  <label className="flex items-center gap-2 w-full">
                    <span className="inline-flex items-center gap-2">
                      ...
                      <WithTooltip
                        ...
                        tooltip={
                          <p>
                            Enables layout debugging on the image. In order to
                            use this functionality you must enable{" "}
                            <Link
        ...
        {launchedFrame && (
          <FrameAppDialog
            ...
            frameState={launchedFrame}
            onClose={() => frameState.onLaunchedFrameClose()}
          />
        )}
      </>
    );
