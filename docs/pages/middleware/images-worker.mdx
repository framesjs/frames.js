...
export const frames = createFrames({
  ...
  middleware: [ // [!code focus]
    imagesWorkerMiddleware({ // [!code focus]
...
See the [basic images worker example](https://github.com/framesjs/frames.js/tree/main/templates/next-starter-with-examples/app/examples/new-api-images-worker) for a complete example.
...
See the [custom images worker example](https://github.com/framesjs/frames.js/tree/main/templates/next-starter-with-examples/app/examples/new-api-images-worker-custom) for an example of how to specify a custom renderer.
