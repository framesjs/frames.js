...
```tsx
// [!include ~/pages/guides/apps/snippets/react-native.tsx]
```
...
```tsx
// [!include ~/pages/guides/apps/snippets/react-native-full.tsx]
```
...
```tsx
// [!include ~/pages/guides/apps/snippets/react-native-nativewind.tsx]
```
