...
To verify the integrity of frame actions you have to include the additional middleware in your `createFrames` call. For Farcaster frames this would be the [`farcasterHubContext`](/middleware/farcasterHubContext) middleware.
